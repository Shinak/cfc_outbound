        ...
        <?php
            ...
            <table cellpadding="7" cellspacing="0" border="0" width="400">
                <tr>
                    ...
                    <td><?php echo form_input('username', $username, 'disabled');?></td>    
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown('right', $options_rights, $option_sel, 'disabled');?></td>    
                </tr>
                <tr>
                    <td valign="top"><?php echo form_button('cancel', 'Cancel', 'onclick="location.href=\''.base_url().'dashboard\'"')?></td>
