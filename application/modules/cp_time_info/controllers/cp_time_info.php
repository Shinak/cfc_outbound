...
class Cp_time_info extends MX_Controller
{
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $query = $this->mdl_cp_time_info->get($order_by);
        return $query;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $query = $this->mdl_cp_time_info->get_with_limit($limit, $offset, $order_by);
        return $query;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $query = $this->mdl_cp_time_info->get_where($id);
        return $query;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $query = $this->mdl_cp_time_info->get_where_custom($col, $value);
        return $query;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $this->mdl_cp_time_info->_insert($data);
    }

    function _update($id, $data) 
    {
        $this->load->model('mdl_cp_time_info');
        $this->mdl_cp_time_info->_update($id, $data);
    }

    function _delete($id) 
    {
        $this->load->model('mdl_cp_time_info');
        $this->mdl_cp_time_info->_delete($id);
    }

    function count_where($column, $value) 
    {
        $this->load->model('mdl_cp_time_info');
        $count = $this->mdl_cp_time_info->count_where($column, $value);
        return $count;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $max_id = $this->mdl_cp_time_info->get_max();
        return $max_id;
    }
    ...
    {
        $this->load->model('mdl_cp_time_info');
        $query = $this->mdl_cp_time_info->_custom_query($mysql_query);
        return $query;
    }
