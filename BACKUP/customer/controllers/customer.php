...
class Customer extends MX_Controller
{
    ...
    function outbound()
    {
        ...
        if($uri_option == "ur")
        {
            Modules::run('customer_resubmission/unset_resubmission', $id);
        }
    ...
    function customer_list($project_id, $order = "", $limit = "")
    {
        ...
        $data['query'] = $this->get_customer_list($project_id, $order, $limit); 
        $data['project_id'] = $project_id;
        
        $this->load->view('list', $data);
    }
    
    function get_customer_list($project_id, $order, $limit = "")
    {
        if($limit != ""){$limit = "limit ".$limit;}
        $query = "Select * from customer where project_id =".$project_id." order by ".$order." ".$limit;
